...
import Thomson.Uniqueness.Tight
import Thomson.Uniqueness.Chords
import Thomson.Uniqueness.Graph
import Thomson.Uniqueness.Gram

/-! # U7: uniqueness of the minimiser — assembly

`docs/uniqueness.md`, step U7.  At a configuration with `energy x = E(u*)`:
