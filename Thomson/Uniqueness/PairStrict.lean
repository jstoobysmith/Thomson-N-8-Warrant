...
`docs/uniqueness.md`, U3.  The sweep of `Thomson.Pair.Sweep` carries a lower bound `p` for `Φ` from
...
(`Thomson.Uniqueness.PairStrictCerts`).  Soundness: `sweep_sound_pos`, `Φ > 0` on `(x₀, gEnd]`. -/
