import Thomson.TriangleLocal.Jet
...
and `6·g₃`, and the fourth derivative is bounded through a majorant of `gL` (`Thomson.TriangleLocal.Jet`).
`rayR` is Task 5a's `rayP` (`Thomson/TriangleLocal/Calculus/TriLocalDeriv.lean`), written out. -/
