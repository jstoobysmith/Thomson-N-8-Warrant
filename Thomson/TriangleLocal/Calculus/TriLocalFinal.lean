import Thomson.TriangleLocal.Calculus.TriLocal4Box
...
(`Thomson/TriangleLocal/Patch.lean`, a peer session's separate, still-in-progress work in the main
...
/-! ## `Qf`, `Kf`, `N2`, `bracket` — restated to match `Thomson.TriangleLocal.Patch` field-for-field -/
