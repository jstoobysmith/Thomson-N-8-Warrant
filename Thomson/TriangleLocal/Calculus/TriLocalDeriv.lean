...
import Thomson.TriangleLocal.Calculus.TriLocalBox
...
polynomial `triP p` (`Thomson.Certificate.Linear`, read-only), the `HasDerivAt` chain that
...
still open (`docs/history/T5a-TriLocal.md` §4/§5/§7); this file only builds the calculus scaffolding they
