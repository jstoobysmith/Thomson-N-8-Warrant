import Thomson.Unique.Main
import Thomson.Unique.PairZero

/-! # Uniqueness of the minimiser, from the tasks

`UniquenessPlan.md`, U7: `Thomson.Unique.thomson_eight_unique_of_tasks` with the pair-zero
hypothesis (U3) discharged by `pairP_eq_zero_iff`.  The Tasks proved with `native_decide` (1a, 1b,
5b and the strict form of 5b) remain hypotheses here, as in `thomson_eight_lower_of_tasks`; they are
...
/-- **Uniqueness of the minimiser**, modulo the `native_decide` tasks: every admissible
