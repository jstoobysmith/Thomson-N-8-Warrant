import Thomson.TriangleGlobal.Symmetry
...
(`Thomson.Certificate.Perturb`).  This file records that reduction with `ε` as a *parameter*.
...
(`Thomson.Antiprism.UStarSharp` supplies the digits).
