...
`Thomson/Tri5b/Checker.lean` (checker + soundness, hand-written), `Thomson/Tri5b/Boxes*.lean`
(generated, many files), `Thomson/Tri5b/Global.lean` (assembly).  `native_decide` for the box
...
## 4. The generator (`threepoint/tri_boxes.py`) — do this first, it is the go/no-go
