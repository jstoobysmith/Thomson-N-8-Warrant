...
*Needs: T0, T1b, T1c(i) (through `pairP_tight`).  Output: `Thomson/ThreePoint/Cert/Pair.lean`,
...
The box list is produced by `threepoint/pair_boxes.py`.  The local part covers `|s − s_X| ≤ ρ_X`,
