...
*Needs: T0, T1b, T1c(ii) (through `triP_tight`).  Output: `Thomson/ThreePoint/Cert/TriLocal.lean`,
...
first (`threepoint/tri_local.py`, finite differences at 30 digits, then the interval value);
...
## 7. Data file (`threepoint/tri_local.py` → `Cert/TriLocalData.lean`)
