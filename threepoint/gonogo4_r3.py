...
# targeted cuts: small dense neighbourhoods of the known sub-grid dips
DIPS=[(-0.755,0.124,0.292),(-0.8311,-0.8311,0.3821)]
loc=np.arange(-0.02,0.0201,0.004); cnt=0
for c in DIPS:
    for dx in loc:
        for dy in loc:
            for dz in loc:
...
print(f"added {cnt} targeted points around the known dips")
