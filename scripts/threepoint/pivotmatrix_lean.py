...
print("json cond/normN/normM", json.load(open('/Users/josephsmith/LocalGithub/ThompsonEight/scripts/threepoint/task1_design.json'))['cond'], json.load(open('/Users/josephsmith/LocalGithub/ThompsonEight/scripts/threepoint/task1_design.json'))['normN'], json.load(open('/Users/josephsmith/LocalGithub/ThompsonEight/scripts/threepoint/task1_design.json'))['normM'])
np.save('A.npy',A)
...
json.dump({"den": DEN,
           ...
           "M_float": A.tolist()},
          open('/Users/josephsmith/LocalGithub/ThompsonEight/scripts/threepoint/task1a_pivotmatrix.json','w'))
