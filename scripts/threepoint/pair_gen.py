...
Usage (from the repository root):  python3 scripts/threepoint/pair_gen.py
"""
import re, os, sys
...
# ---------- Itv (Thomson/TriangleGlobal/Interval.lean) ----------
...
SRC = open(os.path.join(ROOT, "Thomson/TriangleGlobal/CertIntervals.lean")).read()
...
# ---------- emitting Lean ----------
HDR = "-- GENERATED by scripts/threepoint/pair_gen.py; do not edit\n"
